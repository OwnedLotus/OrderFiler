...
var addWindow = new AddWindow("Add Window");
var editWindow = new EditWindow("Edit Window");
var removeWindow = new RemoveWindow("Remove Window");

top?.Add(addWindow,editWindow,removeWindow);
